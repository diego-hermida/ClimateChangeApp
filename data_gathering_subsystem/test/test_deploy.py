...
class TestDeploy(TestCase):
    ...
    @mock.patch('data_gathering_subsystem.deploy.create_application_user', Mock())
    @mock.patch('data_gathering_subsystem.deploy.drop_application_database', Mock())
    ...
    @mock.patch('data_gathering_subsystem.deploy.create_application_user', Mock(side_effect=DuplicateKeyError('User already exists')))
    @mock.patch('argparse.ArgumentParser')
    ...
    @mock.patch('data_gathering_subsystem.deploy.remove_all_under_directory', Mock(side_effect=FileNotFoundError('Directory not found')))
    @mock.patch('argparse.ArgumentParser')
