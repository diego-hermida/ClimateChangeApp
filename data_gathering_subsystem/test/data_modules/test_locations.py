...
LOCATIONS = {'Cairo': {'location_id': 1, 'country_code': 'EG', 'latitude': 30.06263, 'longitude': 31.24967, 'climate_zone': 'A'},
             'Delhi': {'location_id': 2, 'country_code': 'IN', 'latitude': 28.65195, 'longitude': 77.23149, 'climate_zone': 'B'},
             'Guatemala City': {'location_id': 3, 'country_code': 'GT', 'latitude': 14.64072, 'longitude': -90.51327, 'climate_zone': 'C'},
             'Mexico City': {'location_id': 4, 'country_code': 'MX', 'latitude': 19.42847, 'longitude': -99.12766, 'climate_zone': 'D'},
             'Kabul': {'location_id': 9, 'country_code': 'AF', 'latitude': 34.52813, 'longitude': 69.17233, 'climate_zone': 'E'}}
