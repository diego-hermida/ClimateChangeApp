...
import data_modules.future_emissions.future_emissions as future_emissions
...
class TestFutureEmissions(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        future_emissions.instance().remove_files()
    ...
    def test_correct_data_collection(self, mock_collection):
        ...
        # Actual execution
        self.data_collector = future_emissions.instance()
