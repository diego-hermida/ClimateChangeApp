...
import data_modules.sea_level_rise.sea_level_rise as sea_level_rise
...
class TestSeaLevelRise(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        sea_level_rise.instance().remove_files()

    def tearDown(self):
        self.data_collector.remove_files()

    @mock.patch('data_modules.sea_level_rise.sea_level_rise.Reader')
    @mock.patch('data_modules.sea_level_rise.sea_level_rise.FTP')
    ...
    def test_correct_data_collection(self, mock_collection, mock_FTP, mock_Reader):
        ...
        # Actual execution
        self.data_collector = sea_level_rise.instance()
